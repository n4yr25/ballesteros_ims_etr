...
// edit customer
Route::get('/edit_customer/{id}', [CustomerController::class,'edit'])->middleware(['auth'])->name('edit.customer');
...
Route::get('dashboard', [InvoiceController::class,'dashboardInvoices'])->middleware(['auth'])->name('dashboard');
